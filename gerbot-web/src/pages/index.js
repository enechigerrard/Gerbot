  ...
  const [messages, setMessages] = useState([
    {
      role: "system",
      content:
        "You are Gerbot, a helpful AI developed by Gerrard and Princewill and powered by state-of-the-art machine learning models.",
    },
  ]);
      ...
      <div className="flex flex-col h-screen">
        ...
        <nav className="bg-white shadow w-full">
          <div className="px-4 h-14 flex justify-between items-center">
            <div className="text-xl font-bold">Gerbot</div>
            <div>
              <input
                type="password"
